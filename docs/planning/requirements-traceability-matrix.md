...
| `FR-002`       | `PBI-056` | Implement     |
| `FR-002`       | `PBI-057` | Implement     |
...
| `NFR-001`      | `PBI-054` | Verify        |
| `NFR-001`      | `PBI-055` | Verify        |
| `NFR-001`      | `PBI-056` | Verify        |
| `NFR-001`      | `PBI-057` | Verify        |
