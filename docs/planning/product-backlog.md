...
| `PBI-040` | Content | Structure portfolio content source data | Ready   | P1       | [Project Content Inventory](../content/project-content-inventory.md) | Project, contact, link, skill, and disclosure source data are implementation-ready | Complete before wireframe or Astro content-entry work; derive public-safe summaries from private evidence without copying private source text                                                        |
