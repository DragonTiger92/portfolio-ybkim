...
| `PBI-004` | Content    | Draft intro section copy                          | Done        | P1       | [Project Brief](project-brief.md)                                    | First-viewport positioning copy exists                                                      | Exact first-viewport copy is frozen in [Portfolio Copy Source](../content/portfolio-copy-source.md)                             |
| `PBI-005` | Content    | Draft project showcase content                    | Done        | P1       | [Content Model](../architecture/content-model.md)                    | Project summaries and public links are drafted                                              | Project card and detail copy seeds are frozen in [Portfolio Copy Source](../content/portfolio-copy-source.md)                   |
...
| `PBI-018` | Security   | Establish repository security settings baseline   | In Progress | P1       | [Supply Chain Policy](../security/supply-chain.md)                   | Supported GitHub security controls are enabled and recorded                                 | Core controls are recorded; mark Done after the Terraform-managed `main` ruleset is applied following the baseline merge        |
...
| `PBI-034` | Infra      | Establish GitHub governance as code               | In Progress | P1       | [GitHub Governance](../architecture/github-governance.md)            | Repository settings and the `main` ruleset have a reviewed Terraform plan                   | Terraform root exists and keeps deployment infrastructure separate; credentialed plan/apply remain after the baseline merge     |
