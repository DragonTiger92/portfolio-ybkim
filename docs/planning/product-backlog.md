...
| `PBI-042` | Feature    | Apply portfolio i18n for English content | Backlog | P2       | [Content Model](../architecture/content-model.md), [Portfolio Content Source](../content/portfolio-content-source.md) | English recruiter-critical portfolio content is available through an agreed i18n model | Select the i18n implementation tool, library, or static pattern during Phase 4 implementation; do not add an i18n dependency before that decision; decide whether English content is exposed through a route, toggle, or another static-friendly pattern |
