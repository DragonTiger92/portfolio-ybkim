...
| `PBI-021` | Feature | Implement intro section                 | Done    | P1       | [Project Brief](project-brief.md)                                                                                                                                                                                  | First viewport communicates positioning and action                                                              | -                                                                                                                                                                                                                                                                                |
| `PBI-022` | Feature | Implement project showcase              | Done    | P1       | [Content Model](../architecture/content-model.md)                                                                                                                                                                  | Project evidence is concise and inspectable                                                                     | -                                                                                                                                                                                                                                                                                |
