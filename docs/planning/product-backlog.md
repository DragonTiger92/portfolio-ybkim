...
| `PBI-034` | Infra      | Establish GitHub governance as code               | In Progress | P1       | [GitHub Governance](../architecture/github-governance.md)                                                                   | Repository settings and the `main` ruleset have a reviewed Terraform plan                   | HCP project/workspace and backend are prepared with separate state; credentialed plan/apply remain as PH-001 post-merge governance          |
