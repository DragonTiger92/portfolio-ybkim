...
| `PBI-052` | UI      | Unify header and hero visual language   | Done    | P1       | [Design Harness](../../DESIGN.md)                                                                                                                                                                                  | Header navigation and first viewport present one coherent, responsive portfolio identity                                | The elevated header surface, refined identity lockup, navigation and theme controls, and corrected hero hierarchy use the existing brand mark and shared tokens without changing the landing-page information architecture                                        |
