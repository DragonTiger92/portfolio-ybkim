...
| `PBI-019` | Quality    | Optimize event-specific quality gates             | In Progress | P2       | [ADR-0006](../adr/0006-use-github-flow-and-ci-quality-gates.md) | Each Git event runs the smallest sufficient verification set              | Keep pre-commit fast and pull-request checks comprehensive                                                    |
