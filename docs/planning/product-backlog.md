...
| `PBI-018` | Security   | Establish repository security settings baseline   | In Progress | P1       | [Supply Chain Policy](../security/supply-chain.md)                                                                          | Supported GitHub security controls are enabled and recorded                                 | Core controls are recorded; close as PH-001 post-merge governance before PH-002 work, after the Terraform-managed `main` ruleset is applied |
...
| `PBI-047` | Automation | Define Dependabot update lifecycle                | In Progress | P1       | [Supply Chain Policy](../security/supply-chain.md), [GitHub Governance](../architecture/github-governance.md)               | Dependency updates are classified, safely routed, owner-visible, and cleaned up after merge | Routine minor/patch and `deps:validated` exceptional updates remain inactive until PH-001 Terraform applies all safeguards                  |
...
| `PBI-034` | Infra      | Establish GitHub governance as code               | In Progress | P1       | [GitHub Governance](../architecture/github-governance.md)                                                                   | Repository settings and the `main` ruleset have a reviewed Terraform plan                   | Terraform root exists and keeps deployment infrastructure separate; credentialed plan/apply remain as PH-001 post-merge governance          |
