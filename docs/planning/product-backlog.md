...
| `PBI-017` | Automation | Automate GitHub Milestone lifecycle               | In Progress | P1       | `#4`  | [ADR-0006](../adr/0006-use-github-flow-and-ci-quality-gates.md) | Milestones, issues, and phase pull requests stay synchronized             | Use idempotent GitHub Actions and REST API operations                                                                |
| `PBI-018` | Security   | Establish repository security settings baseline   | In Progress | P1       | `#5`  | [Supply Chain Policy](../security/supply-chain.md)              | Supported GitHub security controls are enabled and recorded               | Cover Dependency Graph, Dependabot alerts and security updates, secret scanning, and push protection where available |
