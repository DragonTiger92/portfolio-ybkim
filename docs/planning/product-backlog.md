...
| `PBI-017` | Automation | Automate GitHub Milestone lifecycle               | Backlog     | P1       | -     | [ADR-0006](../adr/0006-use-github-flow-and-ci-quality-gates.md) | Milestones, issues, and phase pull requests stay synchronized | Use idempotent GitHub Actions and REST API operations                                                                |
| `PBI-018` | Security   | Establish repository security settings baseline   | Backlog     | P1       | -     | [Supply Chain Policy](../security/supply-chain.md)              | Supported GitHub security controls are enabled and recorded   | Cover Dependency Graph, Dependabot alerts and security updates, secret scanning, and push protection where available |
| `PBI-019` | Quality    | Optimize event-specific quality gates             | Backlog     | P2       | -     | [ADR-0006](../adr/0006-use-github-flow-and-ci-quality-gates.md) | Each Git event runs the smallest sufficient verification set  | Keep pre-commit fast and pull-request checks comprehensive                                                           |
...
| `PBI-011` | Release    | Establish release deployment workflow           | Backlog | P1       | -     | [ADR-0006](../adr/0006-use-github-flow-and-ci-quality-gates.md)                                   | A controlled production release can publish `v1.0.0`                              | -                                                                |
| `PBI-012` | Infra      | Define infrastructure as code baseline          | Backlog | P2       | -     | [Deployment Architecture](../architecture/deployment.md)                                          | Managed infrastructure scope is explicit                                          | -                                                                |
| `PBI-026` | Security   | Protect the preview environment                 | Backlog | P1       | -     | [Deployment Architecture](../architecture/deployment.md)                                          | Preview access is authenticated and auditable                                     | -                                                                |
